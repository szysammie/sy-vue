...
export default {
  ...
  methods: {
    ...
    confirmNew() {
      ...
      const staffType = this.form.staffType
      const staffName = this.form.staffName
    ...
    // 查询
    search() {
      const staffName = this.searchForm.staffName
      const dataForm = this.$qs.stringify({
        staffName: staffName
      })
      this.$http({
        url: '/api/admin/emp/search',
        method: 'post',
        data: dataForm,
        headers: {
          uid: 'admin',
